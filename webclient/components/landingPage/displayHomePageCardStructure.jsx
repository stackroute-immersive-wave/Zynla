...
getuserName(){
  ...
  for (let i = 0; i < userNames.length; i = i + 1) {
          ...
          if (userNames[i].email !== loginEmail) {
              option.push({ key: userNames[i].name, value: userNames[i].name, text: userNames[i].name});
                      }
        }
  ...
  findMail()
  {
      ...
      if(uname=== ''||uname===undefined)
      {
        ...
        this.closePopup();
        // let wrongMsg='select username to invite';
        // this.inviteAlert(wrongMsg);
        //console.log("entered");
      }
      else {
        let userNames = this.state.userNames;
...
/*eslint-disable*/
    render() {
        ...
        <div class="ui fluid icon input">
          {/* <input style={{'resize': 'horizontal','width': '250px','height':'30px'}}
   ...
   <Dropdown placeholder='search friends here...'
    search selection options={this.state.inviteUser} onChange={this.getValue.bind(this)}/> </div>
 <br/>
